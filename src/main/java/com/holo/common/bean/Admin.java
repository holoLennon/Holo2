...
import com.holo.common.base.BaseEntity;
...
public class Admin extends BaseEntity{
	...
	//alias
	public static final String TABLE_ALIAS = "超级管理员";
	 ...
	 * @param _this
	 */
	public void makedefault(Admin _this){
	}
	public Admin(){
		makedefault(this);
	}
	public Admin(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public Admin(String nickname ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public Admin(Integer id ,String nickname ,String notuse) {
		super();
		this.id = id;
		this.nickname = nickname;
	}
	...
	* @param notuse String 没用
	 */
	public Admin(Integer id ,String nickname ,String notuse,Object notuse2) {
		super();
		this.id = id;
		this.nickname = nickname;
	}
